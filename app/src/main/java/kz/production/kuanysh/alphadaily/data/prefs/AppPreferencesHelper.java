...
public class AppPreferencesHelper implements PreferencesHelper {
    ...
    public Long getCurrentUserId() {
        long userId = mPrefs.getLong(PREF_KEY_CURRENT_USER_ID, AppConst.NULL_INDEX);
        return userId == AppConst.NULL_INDEX ? null : userId;
    }

    @Override
    public void setCurrentUserId(Long userId) {
        long id = userId == null ? AppConst.NULL_INDEX : userId;
